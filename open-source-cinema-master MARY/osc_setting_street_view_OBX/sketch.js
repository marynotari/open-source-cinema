...
function setUp3D(){
  ...
  sirena.position.x = 0;
  sirena.position.y = -1;
  sirena.position.z = 10;
  // sirena.rotation.y = Math.PI/2;
  sirena.rotation.set(new THREE.Vector3( 0, 0, Math.PI / 2));
  ...
  // blackbeard.position.x = 0;
  // blackbeard.position.y = 0;
  // blackbeard.position.z = -50;
