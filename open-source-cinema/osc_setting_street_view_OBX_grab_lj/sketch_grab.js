...
//go to  http://docs.mlab.com/ sign up and get get  api Key and make your own db and collection
var apiKey = "5MvINM5k1SkaPwnYmtPC6Rpu4y4vJlBs";
var db = "open-source-cinema";
var coll = "osc_OBX";

// // REPLACE MARY'S CREDS WITH DANS
...
// ONLY CALL INIT AFTER THE DOCUMENT HAS LOADED
...
// ADD BACK INIT/SETUP FUNCTION BACK
function init(){
  // htmlInterface();
  listOfUsers();
  setUp3D();
...
function setUp3D() {
  ...
  renderer = new THREE.WebGLRenderer({alpha:true}); // ADDED ALPHA : TRUE
  renderer.setSize( window.innerWidth, window.innerHeight );
  //add renderer to the DOM element
  ...
  grabbableMeshes.push(blackbeard);
...
// ONLY RUN ANIMATE AFTER THE SCENE HAS LOADED
animate();
...
// REPLACE GETSCENE WITH SAME FUNCTION FROM SKETCH.JS
function getScene(){
